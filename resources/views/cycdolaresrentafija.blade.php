...
@section('content')
    <div>
        {{-- slide --}}
        <div style="background-image: url({{ asset('/img/fondo_filtro.png')}}), url({{ asset('/img/fondo_dolar_renta_fija.jpg')}})" class="bg-cover bg-center bg-no-repeat xxs:h-48 xs:h-48 sm:h-84 lg:h-64 xl:h-96">
            <div class="container flex items-center justify-center h-full">
                <div class="flex flex-col justify-center items-center w-full">
                    <h1 class="font-body text-white text-shadow font-bold text-3xl pb-6 text-center">Busca rendimientos en dólares con una<br/>cartera de bonos bien diversificada</h1>
                    <p class="font-body text-white text-center text-shadow xxs:text-xxs xs:text-base sm:text-1xl md:text-1xl lg:text-1xl xl:text-1xl">
                        CYC Dólares Renta Fija se concentra en la inversión en bonos corporativos, soberanos y sub-soberanos argentinos emitidos y pagaderos en dólares. Una menor proporción podrá ser destinada a Treasury Bills del Tesoro Americano y liquidez según contexto de mercado. El fondo busca obtener la mejor relación riesgo-retorno en comparación a los rendimientos de las curvas soberanas y cooperativas argentinas.
                    </p>
                </div>
